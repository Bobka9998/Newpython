...
# 22 ni 4 ga bo`lganda qancha qoldik qoladi
print(22/4)
# Tomonlari 125 ga teng kvadratning yuzi va perimetirini toping.
print(125**2)
# Diametri 12 ga teng bo`lgan doiraning yuzini toping p=3.14
print(3.14*12**2)
# Katetlari 6 va 7 ga teng bo`lgan to`g`ri burchakli uchburchakning gipotenuzasini toping 
print(6**2+7**2)
